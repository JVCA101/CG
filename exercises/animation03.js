...
let cylinderGeometry34 = new THREE.CylinderGeometry(0.07, 0.07, 1.0, 25);
let cylinderMaterial34 = new THREE.MeshPhongMaterial( {color:'yellow'} );
let cylinder3 = new THREE.Mesh( cylinderGeometry34, cylinderMaterial34 );
let cylinder4 = new THREE.Mesh( cylinderGeometry34, cylinderMaterial34 );
