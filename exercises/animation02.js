...
{
  sphere1.translateX(lerpConfig1.alpha);
}

function moveSphere2()
{
  sphere2.translateX(lerpConfig2.alpha);
}
...
function render()
{
  if(lerpConfig1.move && sphere1.position.x < lerpConfig1.destination.x)
  {
    moveSphere1();
  }
  if(lerpConfig2.move && sphere2.position.x < lerpConfig2.destination.x)
  {
    moveSphere2();
  }
